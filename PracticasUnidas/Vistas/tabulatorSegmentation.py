...
class TabulatorSegmentation(ttk.Frame):
    ...
    def __init__(self, parent):
        """
        Inicializa la pestaña de segmentación.
    ...
    def _crear_componentes_segmentacion_img1(self):
        ...
        # Botones de métodos de segmentación
    ...
    def pedir_valor_umbrales(self, tipo_segmentacion):
        """
        Solicita al usuario los valores de umbrales necesarios para ciertos métodos de segmentación.
        
        Args:
            tipo_segmentacion (str): 'dos umbrales' o 'umbral de banda'.
            
        Returns:
            tuple: (valor_umbral_1, valor_umbral_2) o (None, None) si se cancela.
        """
